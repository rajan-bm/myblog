...
function watchFiles() {
    ...
    gulp.watch("./src/update/**/*", images.optimizeImages2);
...
const build = gulp.series(
    clean.all,
    gulp.parallel(copy.copyHtml, copy.copyFonts, copy.copyFavicon, copy.copyPhp, copy.copyPhpConfig, copy.copyPhpLib, css.buildCss, css.minifyCSS, images.optimizeImages, images.optimizeImages2, scripts)
);
